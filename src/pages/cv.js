                ...
                <div className="row pad-5">
                  ...
                  >
                    ...
                    <p className="body-text margin-1-tb">
                      ...
                      design. Looking for the next challenge to improve customer
                  ...
                  <div className="col-xs-3">
                    ...
                    <p className="body-text margin-0 margin-1-t margin-3-b">
                      Everything from wildlife to wedding photography. One of my
                      photos "The Brighton Fox" was featured in Brighton &

                    ...
                    <div className="row ">
                      ...
                      <div className="col-xs-3">
                        ...
                        <p className="body-text margin-0 margin-1-t margin-3-b">
                          I enjoy teaching the next generation to code and have
                          a bit of a reputation for staying up all night.
                        </p>
                        <h4 className="margin-0 margin-1-t">Photography</h4>
                        <p className="body-text margin-0 margin-1-t margin-3-b">
                          Everything from wildlife to wedding photography. One
                          of my photos "The Brighton Fox" was featured in
                          Brighton & Hove's Annual Calendar in 2019.
                        </p>
                      </div>

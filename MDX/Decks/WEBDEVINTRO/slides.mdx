...
Library NOT Framework - something tht enhances your exisiting code
...
This is like JQuery you would grab the element in the dom get the text value increase it and set the element to the new value in the browser.

But React is more like a Tesla. You set the exact temprature that you want and then the car then decides whether you need to make it cooler or warmer.
...
## *"You're putting HTML in my Javascript. You must be f\*\*\*ing kidding me!"*

---

This is not HTML - This is JSX. Its a templating language that looks like HTML.

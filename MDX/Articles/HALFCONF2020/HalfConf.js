    ...
    <div className="is-white-bg-always is-grey-always pad-5 row pandemic-poster">
      <div className="col-xs-12">
        ...
        <div className="row">
          ...
          <div className="col-xs-12 margin-5-b">
            ...
            <h4 className="margin-0 margin-1-tb ">
              ...
              like the "Myo Armband" to change the way we interact with our
              browsers.
            </h4>
          </div>
          ...
          <div className="col-xs-12 col-md-6  margin-5-b flex ">
            ...
            <div className="flex " style={{ flexDirection: "column" }}>
              ...
              <p className="margin-2-l margin-0">
                ...
                package called "react-webcam" thats great for getting started.
                We explored some libraries that can make use of webcam data in
                detail below.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <ul className="margin-1-t">
              <li>
                ...
                <p className="margin-1-t">
                  We could in the future have a "motion-mode" like "dark-mode"
                  on our websites. This could be a toggle feature that when on
                  allows the user to navigate a website with any pose, gesture,
                  facial expression.
                </p>
              </li>
              <li>
        ...
        <div className="col-xs-12 text-align-center margin-5-t margin-3-b">
          <p className="">
            <strong>
              "HCI is broad so start small - focus on one piece of the puzzle.
              Use one library or device and have fun!"
            </strong>
          </p>
          ...
          <div className="col-xs-12 col-md-6  margin-5-b flex">
            ...
            <div className="flex " style={{ flexDirection: "column" }}>
              ...
              <p className="margin-2-l margin-1-tb">
                ...
                sickness or maybe they don't want to wait for your animations to
                finish. This doesnt mean you can't use any motion, just be
                mindful.
              </p>
            </div>
          </div>
        ...
        <div className="row">
          ...
          >
            ...
            <p className="margin-1-tb">
              ...
              cultural and social differences we're creating with innovation.
            </p>
            <p>

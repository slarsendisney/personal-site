...
desc: Encouraging those that have shown interest in the content to sign up. Creating a higher quality audience that are more likely to interact with emails I send them. and working out how we can define an engaged user?
coverimg: "./hero.png"
date: 2020-06-19
tags: [react, ux, hooks]
---

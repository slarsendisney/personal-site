...
<div className="is-yellow-bg pad-2 pad-3-lr border-radius">
  <p className="margin-0"> This is my first attempt at a deep dive. Its longer than most of my posts and features rather a lot of code examples. Hope that's cool. </p>
</div>

...
const Overlay = ({
  ...
  const iheight = 630;
  const xMargin = 60;
  const textArray = title ? largeText ? title.match(/.{1,23}(\s|$)/g) : title.match(/.{1,16}(\s|$)/g) : [];
  const tagsString = tags ? tags.reduce((text, value, i, array) => i > 0 ? text + (i < array.length - 1 ? ", " : " & ") + jsUcfirst(value) : jsUcfirst(value), "") : [];
  ...
  return /*#__PURE__*/_react.default.createElement("svg", {
    ...
    y: texty
  }, textArray && textArray.map((line, index) => /*#__PURE__*/_react.default.createElement("tspan", {
    x: xMargin,
    ...
    x: xMargin,
    dy: xlText ? 65 : 50
  }, "The Portfolio of Sam Larsen-Disney")), !noMeta && tagsArray && tagsArray.map((line, index) => /*#__PURE__*/_react.default.createElement("tspan", {
    key: line,
    fontSize: "35",
    fontWeight: "semibold",
    fill: "#44444480",
    ...
    dy: 50
  }, line)), !noMeta && type === "Article" && /*#__PURE__*/_react.default.createElement("tspan", {
    fontSize: "35",
    fontWeight: "semibold",
    fill: "#44444480",
    x: xMargin + 45,
    dy: 50
  }, timeToRead, " minute read")), !noMeta && /*#__PURE__*/_react.default.createElement("svg", {
    ...
    id: "Shape"
  }))))), !noMeta && type === "Article" && tagsArray && /*#__PURE__*/_react.default.createElement("svg", {
    y: texty + 22 + (textArray.length - 1) * (largeText ? 65 : 75) + tagsArray.length * 50,
    x: xMargin,
    width: "32px",
    height: "32px",
    viewBox: "0 0 32 32",
